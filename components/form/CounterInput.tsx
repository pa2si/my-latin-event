      ...
      <CardHeader className="flex flex-col gap-y-5">
        <div className="flex flex-wrap items-center justify-between">
          <div className="flex flex-col">
            <h2 className="text-md font-antonio font-bold capitalize tracking-wide">
              {detailDisplayNames[detail] || formatCamelCase(detail)}
            </h2>
            <p className="text-md font-mono text-[0.8rem] tracking-tighter text-muted-foreground">
              Specify the number of{" "}
              {detailDisplayNames[detail] ||
                formatCamelCase(detail).toLowerCase()}
            </p>
          </div>
          <div className="flex items-center gap-4">
            ...
            <span className="text-md w-5 text-center font-antonio text-xl font-bold">
              {count}
            </span>
            <Button
              variant="outline"
